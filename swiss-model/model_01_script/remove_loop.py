...
config = {
    "in_template": os.path.join("swiss-model", "model_01_add-terminal_reorder_numbered.pdb"),
    "out_template": os.path.join("swiss-model", "model_01_add-terminal_reorder_numbered_rmv.pdb"),
